        ...
        <div style={{ maxWidth: 720, margin: '0 auto', padding: '52px 24px' }}>
          <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 'clamp(22px,3vw,32px)', fontWeight: 400, color: '#1A1714', marginBottom: 32, textAlign: 'center' }}>Your planning tools shouldn't feel like grading more work</h2>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                <div style="width:32px;height:32px;border-radius:50%;background:#F5EEF8;display:flex;align-items:center;justify-content:center;flex-shrink:0">
                  <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="#8E44AD" strokeWidth="1.8"><path d="M13 4L6 11 3 8"/></svg>
                </div>
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">Notion requires you to be a developer to use it well</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">Building databases, creating linked views, learning formulas — this is not what teachers have time for at 10pm.</div>
                </div>
              </div>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                ...
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">Your paper planner doesn't sync and your digital one feels cold</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">The warmth of a paper planner and the convenience of digital don't have to be mutually exclusive.</div>
                </div>
              </div>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                ...
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">Professional development, lesson planning, and grading deadlines all live in different places</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">StudyBoard for your courses, WorkBoard for your department, EventBoard for professional milestones.</div>
                </div>
              </div>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                ...
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">You want to share your planning without sharing your entire system</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">A read-only view of your StudyBoard for a department head. A shared EventBoard for a field trip. Without giving anyone edit access to everything.</div>
                </div>
              </div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '60px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 16 }}>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                <div style="width:36px;height:36px;border-radius:8px;background:#F5EEF8;display:flex;align-items:center;justify-content:center;margin-bottom:12px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">Works on day one — no setup</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">No databases to build, no templates to configure. Add your semester's deadlines in 5 minutes.</div>
              </div>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">Serif typography that feels like your planner</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">Cormorant Garamond headers. Warm cream background. The aesthetic of a quality paper planner, in a synced digital form.</div>
              </div>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">Read-only sharing for department transparency</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">Share your WorkBoard or StudyBoard as view-only with a department head or colleague. They see your planning without being able to edit it.</div>
              </div>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">Markdown notes for lesson context</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">Add formatted notes to any item — bold key standards, bullet materials lists, link to resources. Renders cleanly in read mode.</div>
              </div>
        </div>
      </div>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white', borderRadius: 12, overflow: 'hidden', border: '0.5px solid #C8BFB5' }}>
            ...
            <tbody>
                  ...
                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">Works on day one</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">✗ Must build</td>
                  </tr>

                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">Warm editorial aesthetic</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">~ Cold minimal</td>
                  </tr>

                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">No learning curve</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">✗ Hours of setup</td>
                  </tr>

                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">Markdown notes</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                  </tr>

                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">Read-only sharing</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                  </tr>
                  ...
                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    ...
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">Free · $99/yr Pro</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">$120/yr</td>
                  </tr>
            </tbody>
          </table>
        </div>
