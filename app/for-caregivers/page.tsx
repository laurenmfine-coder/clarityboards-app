        ...
        <div style={{ maxWidth: 720, margin: '0 auto', padding: '52px 24px' }}>
          <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 'clamp(22px,3vw,32px)', fontWeight: 400, color: '#1A1714', marginBottom: 32, textAlign: 'center' }}>Caregiving is hard. Your tools shouldn't make it harder.</h2>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                ...
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">You can't remember if you gave the 2pm medication</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">Most to-do apps delete completed tasks. There's no way to look back without a paper trail.</div>
                </div>
              </div>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                ...
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">You're coordinating care across multiple people</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">Texting back and forth about who did what, when. Nothing is in one place.</div>
                </div>
              </div>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                ...
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">Your care notes live in a different app than your tasks</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">Notes in one place, reminders in another, calendar in a third. Switching between them costs you focus.</div>
                </div>
              </div>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                ...
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">No record to show the doctor or care team</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">When a doctor asks 'how has she been this week?' — you're guessing from memory.</div>
                </div>
              </div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '60px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 16 }}>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                <div style="width:36px;height:36px;border-radius:8px;background:#E1F5EE;display:flex;align-items:center;justify-content:center;margin-bottom:12px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">Archive, don't delete</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">Every completed task is archived, not erased. Restore it in one tap, or browse your full care history.</div>
              </div>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">Share with your care team</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">Invite family members, siblings, or a professional caregiver as viewer or contributor. Everyone sees the same picture.</div>
              </div>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">Notes that remember context</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">Markdown notes on every item — bold key instructions, bullet medication schedules, add links to care plans.</div>
              </div>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">One view for your whole care picture</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">Events, tasks, and recurring items in one board. Not scattered across 4 different apps.</div>
              </div>
        </div>
      </div>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white', borderRadius: 12, overflow: 'hidden', border: '0.5px solid #C8BFB5' }}>
            ...
            <tbody>
                  ...
                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">Completed task archive</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">✗ Deleted forever</td>
                  </tr>

                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">Restore archived items</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#A32D2D;font-weight:500">✗</td>
                  </tr>

                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">Shared care team access</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">✓ Viewer/Editor</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">✗ or $$</td>
                  </tr>

                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">Markdown care notes</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">✗ Plain text only</td>
                  </tr>

                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">Recurring medication reminders</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">~ Basic</td>
                  </tr>

                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">Free to start</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
