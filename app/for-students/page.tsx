        ...
        <div style={{ maxWidth: 720, margin: '0 auto', padding: '52px 24px' }}>
          <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 'clamp(22px,3vw,32px)', fontWeight: 400, color: '#1A1714', marginBottom: 32, textAlign: 'center' }}>Sound like your semester?</h2>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                <div style="width:32px;height:32px;border-radius:50%;background:#E8F8F6;display:flex;align-items:center;justify-content:center;flex-shrink:0">
                  <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="#2E9E8F" strokeWidth="1.8"><path d="M13 4L6 11 3 8"/></svg>
                </div>
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">You spend Sunday setting up Notion instead of studying</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">The database, the linked views, the templates — it takes hours to build and minutes to abandon.</div>
                </div>
              </div>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                ...
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">Your deadlines are in three different places</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">Canvas, phone reminders, sticky notes, and a planner that's already two weeks behind.</div>
                </div>
              </div>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                ...
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">You check off a task and it disappears forever</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">Did you submit that paper? Did you finish that problem set? With most apps, you'll never know.</div>
                </div>
              </div>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                ...
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">Your study system collapses by week 4</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">You start with a great setup. Then life happens and the system gets too complex to maintain.</div>
                </div>
              </div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '60px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 16 }}>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                <div style="width:36px;height:36px;border-radius:8px;background:#E8F8F6;display:flex;align-items:center;justify-content:center;margin-bottom:12px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">StudyBoard ready in 60 seconds</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">Add assignments, set due dates, mark as In Progress or Submitted. Works before you finish your first coffee.</div>
              </div>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">Archive proves you did the work</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">Completed assignments move to an archive, not a trash can. You can restore anything — useful when a professor says they never got your submission.</div>
              </div>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">⌘J anywhere to add a task</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">Keyboard shortcut opens the add modal instantly. Faster than Todoist, cleaner than a sticky note.</div>
              </div>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">Dark mode for late nights</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">Beautiful warm dark mode that doesn't blast your eyes at 2am. Switch with one click.</div>
              </div>
        </div>
      </div>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white', borderRadius: 12, overflow: 'hidden', border: '0.5px solid #C8BFB5' }}>
            ...
            <tbody>
                  ...
                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    ...
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">✗ Must build first</td>
                  </tr>

                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">Task archive (proof of work)</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                  ...
                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    ...
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">✗ ~40 hrs to master</td>
                  </tr>

                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">⌘J quick-add</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">~</td>
                  </tr>

                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">Dark mode</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                  </tr>

                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">Free tier</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">✓ Generous</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">✓ Limited</td>
                  </tr>
            </tbody>
          </table>
        </div>
