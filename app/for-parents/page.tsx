        ...
        <div style={{ maxWidth: 720, margin: '0 auto', padding: '52px 24px' }}>
          <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 'clamp(22px,3vw,32px)', fontWeight: 400, color: '#1A1714', marginBottom: 32, textAlign: 'center' }}>The coordination tax of modern family life</h2>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                <div style="width:32px;height:32px;border-radius:50%;background:#FEF3E8;display:flex;align-items:center;justify-content:center;flex-shrink:0">
                  <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="#E67E22" strokeWidth="1.8"><path d="M13 4L6 11 3 8"/></svg>
                </div>
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">You're the family secretary because no one else uses the app</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">If the interface is ugly or confusing, your partner ignores it and you end up entering everything yourself.</div>
                </div>
              </div>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                ...
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">Kids' activities, school events, and family tasks live in separate places</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">ActivityBoard, EventBoard, and TaskBoard keep everything in one place without making it feel like a work tool.</div>
                </div>
              </div>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                ...
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">Group texts are your family's task manager</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">Things get lost. No one remembers who was supposed to RSVP to the birthday party.</div>
                </div>
              </div>
              ...
              <div style="display:flex;gap:14px;align-items:flex-start;margin-bottom:20px">
                ...
                <div>
                  <div style="font-size:15px;font-weight:500;color:#1A1714;margin-bottom:3px">Sharing a calendar is different from sharing a plan</div>
                  <div style="font-size:13px;color:#6B6059;line-height:1.6">Google Calendar shows when. Clarityboards shows what, who, and done — with a history of everything completed.</div>
                </div>
              </div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '60px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 16 }}>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                <div style="width:36px;height:36px;border-radius:8px;background:#FEF3E8;display:flex;align-items:center;justify-content:center;margin-bottom:12px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">Boards for every part of family life</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">EventBoard for celebrations. ActivityBoard for kids' sports and activities. TaskBoard for household to-dos. Each one organized, each one shareable.</div>
              </div>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">Invite your partner in 30 seconds</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">Type their email, pick Viewer or Contributor, send. They get a warm invite email and can start adding items immediately.</div>
              </div>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">Archive keeps the family history</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">Every completed task is archived, not deleted. Who prepared for the recital, who handled the college application — it's all there.</div>
              </div>
              ...
              <div style="background:white;border:0.5px solid #C8BFB5;border-radius:12px;padding:20px">
                ...
                <div style="font-size:14px;font-weight:500;color:#1A1714;margin-bottom:6px">Beautiful enough to open without being asked</div>
                <div style="font-size:13px;color:#6B6059;line-height:1.6">Warm, editorial, calm. Not a corporate tool that feels like homework. The kind of app your family opens because it feels good.</div>
              </div>
        </div>
      </div>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white', borderRadius: 12, overflow: 'hidden', border: '0.5px solid #C8BFB5' }}>
            ...
            <tbody>
                  ...
                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">Modern interface</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">✗ Dated design</td>
                  </tr>

                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    <td style="padding:10px 12px;font-size:13px;color:#1A1714;font-weight:500">Contributor editing</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#3B6D11;font-weight:500">✓</td>
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">✓ Anyone</td>
                  </tr>
                  ...
                  <tr style="border-bottom:0.5px solid #EDE8E2">
                    ...
                    <td style="padding:10px 12px;font-size:13px;text-align:center;color:#854F0B;font-weight:500">✗ No control</td>
                  </tr>
